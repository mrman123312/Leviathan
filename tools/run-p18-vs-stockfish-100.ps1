...
$RepoCommit='535b8e14161f21dc6394d895c01145af18e31af2'
$Root=Join-Path $HOME 'LeviathanHardwareResults'
$Work=Join-Path $Root 'p18.2-one-shot-work'
New-Item -ItemType Directory -Force -Path $Root | Out-Null

Write-Host '=== P18.4 FULL CPU+GPU VS STOCKFISH / 100 GAMES ===' -ForegroundColor Magenta
...
Write-Host '=== START 100-GAME FAIR PONDER MATCH ===' -ForegroundColor Magenta
Write-Host 'Both engines get equal CPU thread/hash budgets and equal own-move time.'
Write-Host 'Both are allowed UCI pondering. Leviathan additionally uses the RTX GPU advisor and multi-reply ponder portfolio.'
...
Assert-LastExit '100-game P18.4 vs Stockfish match'

Write-Host "`n=== DONE: P18.4 CPU+GPU VS STOCKFISH 100 GAMES ===" -ForegroundColor Green
