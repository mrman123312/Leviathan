...
$trainRows = Join-Path $out "train.jsonl"; $holdRows = Join-Path $out "prospective.jsonl"; $model = Join-Path $out "p18.2.pt"; $metrics = Join-Path $out "p18.2.metrics.json"
...
Write-Host "=== Checkpoint passed prospective gates ==="
